...
| Relaciónes | Política de borrado | Descripción |
| :--- | :--- | :--- |
...
| **Receta_medica → Detalle_venta**| `ANULAR` | Si una receta médica debe ser purgada del sistema (por políticas de privacidad o retención de datos), el detalle de la venta se conserva intacto para la auditoría financiera, dejando el identificador de la receta en blanco. |
